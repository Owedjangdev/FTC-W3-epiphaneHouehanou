...
const PuppyCard: React.FC<{ puppy: Puppy }> = ({ puppy }) => (
  <Link
    href={`/puppy/${puppy.id}`}
    className="block bg-white rounded-xl shadow-lg overflow-hidden transition-transform transform hover:scale-105"
  >
    ...
    <div className="p-4">
      ...
      <p className="text-sm text-gray-600 mb-1">
        ...
        <span className="font-semibold">{puppy.age}</span> old
      </p>
...
const SeeMorePuppiesSection: React.FC = () => {
  return (
    <section className="py-16">
      <h2 className="text-3xl font-bold text-[#002444] mb-4">
        What’s new? <br />
        See More Puppies
      </h2>
