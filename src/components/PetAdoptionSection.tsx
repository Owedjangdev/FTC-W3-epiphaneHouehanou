        ...
        <div className="container mx-auto py-12 sm:py-16 px-4">
            ...
            <div className="mb-12 sm:mb-16">
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 sm:mb-8">
                    ...
                    <div>
                        <Link href="#" className="flex items-center text-[#0c3c6d] font-semibold transition-colors hover:text-[#092a4e]">
                            View all our sellers <ArrowRight className="ml-2 w-4 h-4" />
                        </Link>
                    </div>
                </div>

                {/* La grille des logos est masquée sur les petits écrans et affichée sur les écrans md et plus grands */}
                <div className="hidden md:grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-7 gap-4 sm:gap-6 items-center justify-items-center">
                    {petBrands.map((brand) => (
                        <div key={brand.name} className="relative w-28 h-12 sm:w-32 sm:h-16 flex items-center justify-center p-2">
                            <Image
                                src={brand.logo}
                                alt={brand.name}
                                width={100}
            ...
            <div className="relative bg-secondary rounded-3xl shadow-xl overflow-hidden flex flex-col lg:flex-row">
                ...
                <div className="flex-1 p-8 md:p-12 lg:p-16 flex flex-col justify-center relative z-10">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4">
                        <Link href="#" className="px-6 sm:px-8 py-3 sm:py-4 rounded-full bg-[#0c3c6d] text-white font-semibold transition-colors duration-300 hover:bg-[#092a4e] text-center">
                            Explore Now
                        </Link>
                        <Link href="#" className="flex items-center justify-center px-6 sm:px-8 py-3 sm:py-4 rounded-full text-gray-600 border-2 border-gray-400 transition-colors duration-300 hover:bg-gray-200">
                            View Intro
                ...
                {/* Image de droite (patte de chien) - Gérée avec une logique de réactivité */}
